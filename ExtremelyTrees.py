...
def ploting(pred_y_matrix, yij_matrix, depth_value):
    ...
    for i in range(len(pred_y_matrix)):
        ...
        print("The Multi Class Log Loss for ExtraTrees is: ", MCLL, " Number of Trees: ", trees[i], " Depth = ", depth_value)
...
if __name__ == "__main__":
    ...
    y_ij = y_generate()
    print("Start Ploting")
    pred_y_10 = extratrees(10)
    pred_y_20 = extratrees(20)
    pred_y_30 = extratrees(30)
    pred_y_40 = extratrees(40)
